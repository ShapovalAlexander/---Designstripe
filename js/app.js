(() => {
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("header__search")) document.querySelector(".button-search__form").classList.toggle("_active"); else if (!targetElement.closest(".button-search__form") && document.querySelector(".button-search__form._active")) document.querySelector(".button-search__form").classList.remove("_active");
        }
    };
    window["FLS"] = true;
    isWebp();
